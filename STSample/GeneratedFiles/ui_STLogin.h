/********************************************************************************
** Form generated from reading UI file 'STLogin.ui'
**
...
public:
    ...
    void setupUi(QWidget *STLoginClass)
    {
        if (STLoginClass->objectName().isEmpty())
            STLoginClass->setObjectName(QStringLiteral("STLoginClass"));
        ...
        widTop = new QWidget(STLoginClass);
...
"}"));
    ...
    void retranslateUi(QWidget *STLoginClass)
    {
        ...
        pb2Regist->setText(QApplication::translate("STLoginClass", "\346\226\260\347\224\250\346\210\267\346\263\250\345\206\214", 0));
    } // retranslateUi

};

namespace Ui {
    class STLoginClass: public Ui_STLoginClass {};
} // namespace Ui
